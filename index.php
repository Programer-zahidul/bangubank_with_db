...
// This is a simple banking application, its HTML template provided by Laravel batch 2 team
// now complete these project with functionality in PHP Language and can not use Database. For store data
...
<body class="flex flex-col items-baseline justify-center min-h-screen">
  <section class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
    ...
    <div class="flex flex-col gap-2 mb-8 lg:mb-16 md:flex-row md:justify-center">
      ...
      <a href="./admin/login.php" type="button"
